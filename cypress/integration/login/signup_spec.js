...
describe('Signup Email page', () => {
    ...
    it('should match elements, body', () => {
        ...
        cy.get('#signin_account_link').should(
            'contain',
        ...
        cy.get('#signup_agreement').should(
            'contain',
            'By proceeding to create your account and use Mattermost, you agree to our Terms of Service and Privacy Policy. If you do not agree, you cannot use SCC.',
        );
        cy.get(
            "#signup_agreement > span > [href='https://about.securCom.me/default-terms/']",
        ).should('be.visible');
        cy.get(
            "#signup_agreement > span > [href='https://about.securCom.me/default-privacy-policy/']",
        ).should('be.visible');
    });
