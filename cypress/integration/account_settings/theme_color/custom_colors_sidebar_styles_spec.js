...
const testCases = [
    {
        key: 0,
        name: 'Sidebar BG',
        inputTarget: '.hue-horizontal',
        inputColor: ['background-color', 'rgb(20, 191, 188)'],
        content: "'sidebarBg':'#14bfbc'",
    },
    {
        key: 1,
        name: 'Sidebar Text',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 65, 65)'],
        content: "'sidebarText':'#814141'",
    },
    {
        key: 2,
        name: 'Sidebar Header BG',
        inputTarget: '.hue-horizontal',
        inputColor: ['background-color', 'rgb(17, 171, 168)'],
        content: "'sidebarHeaderBg':'#11aba8'",
    },
    {
        key: 3,
        ...
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 65, 65)'],
        content: "'sidebarHeaderTextColor':'#814141'",
    },
    {
        key: 4,
        name: 'Sidebar Unread Text',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 65, 65)'],
        content: "'sidebarUnreadText':'#814141'",
    },
    {
        key: 5,
        name: 'Sidebar Text Hover BG',
        inputTarget: '.hue-horizontal',
        inputColor: ['background-color', 'rgb(69, 191, 191)'],
        content: "'sidebarTextHoverBg':'#45bfbf'",
    },
    {
        key: 6,
        name: 'Sidebar Text Active Border',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(65, 92, 129)'],
        content: "'sidebarTextActiveBorder':'#415c81'",
    },
    {
        key: 7,
        name: 'Sidebar Text Active Color',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 65, 65)'],
        content: "'sidebarTextActiveColor':'#814141'",
    },
    {
        key: 8,
        name: 'Online Indicator',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(65, 129, 113)'],
        content: "'onlineIndicator':'#418171'",
    },
    {
        key: 9,
        name: 'Away Indicator',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 106, 65)'],
        content: "'awayIndicator':'#816a41'",
    },
    {
        key: 10,
        name: 'Do Not Disturb Indicator',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 65, 65)'],
        content: "'dndIndicator':'#814141'",
    },
    {
        key: 11,
        name: 'Mention Jewel BG',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(129, 65, 65)'],
        content: "'dndIndicator':'#814141'",
    },
    {
        key: 12,
        name: 'Mention Jewel Text',
        inputTarget: '.saturation-black',
        inputColor: ['background-color', 'rgb(65, 92, 129)'],
        content: "'mentionColor':'#415c81'",
    },
];
...
describe('AS14318 Theme Colors - Color Picker', () => {
    ...
    describe('Custom - Sidebar Styles input change', () => {
        ...
        it('should observe color change in Account Settings modal before saving', () => {
            ...
            cy.get('#accountSettingsHeader').should(
                'have.css',
                'background',
                'rgb(17, 171, 168) none repeat scroll 0% 0% / auto padding-box border-box',
            );

            // * Check Sidebar Header Text color change
            cy.get('#accountSettingsModalLabel').should(
                'have.css',
                'color',
                'rgb(129, 65, 65)',
            );
    ...
    describe('Custom - Sidebar styles target output change', () => {
        it('should take effect each custom color in Channel View', () => {
            ...
            cy.get('.sidebar-item.unread-title').should(
                'have.css',
                'color',
                'rgb(129, 65, 65)',
            );
            ...
            cy.get('#unreadIndicatorBottom').should(
                'have.css',
                'background-color',
                'rgb(129, 65, 65)',
            );
