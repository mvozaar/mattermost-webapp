...
describe('Emoticons', () => {
    describe('handleEmoticons', () => {
        ...
        Array.prototype
            .concat(...Object.values(emoticonPatterns))
            .forEach((emoticon) => {
                test(`text sequence '${emoticon}' should be recognized as an emoticon`, () => {
                    expect(
                        Emoticons.handleEmoticons(emoticon, new Map()),
        ...
        test('should allow comma immediately following emoticon :)', () => {
            expect(Emoticons.handleEmoticons(':),', new Map())).toEqual(
                '$MM_EMOTICON0$,',
            );
        });

        test('should allow comma immediately following emoticon :P', () => {
            expect(Emoticons.handleEmoticons(':P,', new Map())).toEqual(
                '$MM_EMOTICON0$,',
            );
        });
