...
describe('TextFormatting.AtMentions', () => {
    it('At mentions', () => {
        ...
        assert.equal(
            TextFormatting.autolinkAtMentions(
                '@user1/@user2/@user3',
                new Map(),
            ),
    ...
    it('Highlighted at mentions', () => {
        assert.equal(
            TextFormatting.formatText('@user', {
                atMentions: true,
                mentionKeys: [{key: '@user'}],
            }).trim(),
            "<p><span class='mention--highlight'><span data-mention='user'>@user</span></span></p>",
        );

        assert.equal(
            TextFormatting.formatText('@channel', {
                atMentions: true,
        ...
        assert.equal(
            TextFormatting.formatText('@foo.com', {
                atMentions: true,
                mentionKeys: [{key: '@foo.com'}],
            }).trim(),
            "<p><span class='mention--highlight'><span data-mention='foo.com'>@foo.com</span></span></p>",
        );

        assert.equal(
            TextFormatting.formatText('@foo.com @bar.com', {
                atMentions: true,
