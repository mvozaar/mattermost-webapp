...
describe('formatWithRenderer | LinkOnlyRenderer', () => {
    const testCases = [
...

        {
            ...
            inputText:
                '###### H6 header\n[link 1](https://securCom.me) - [link 2](https://securCom.me)',
            outputText:
                "H6 header <a class='theme markdown__link' href='https://securCom.me' target='_blank'>" +
                "link 1</a> - <a class='theme markdown__link' href='https://securCom.me' target='_blank'>link 2</a>",
        },
...

        {
            ...
            inputText: 'Do you like www.securCom.me?',
            outputText:
                "Do you like <a class='theme markdown__link' href='http://www.securCom.me' target='_blank'>" +
                'www.securCom.me</a>?',
        },

        {
            description: 'link: link with a scheme',
            inputText: 'Do you like http://www.securCom.me?',
            outputText:
                "Do you like <a class='theme markdown__link' href='http://www.securCom.me' target='_blank'>" +
                'http://www.securCom.me</a>?',
        },

        {
            description: 'link: link with a title',
            inputText: 'Do you like [securCom](http://www.securCom.me)?',
            outputText:
                "Do you like <a class='theme markdown__link' href='http://www.securCom.me' target='_blank'>" +
                'Mattermost</a>?',
        },
