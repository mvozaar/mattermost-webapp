...
const STOP_TYPING = {
    type: 'stop_typing',
    data: {
        id: 'current_channel_idundefined',
...
describe('actions/post_utils', () => {
    ...
    test('completePostReceive', async () => {
        ...
        await testStore.dispatch(
            PostActionsUtils.completePostReceive(newPost, websocketProps),
        );
    ...
    test('lastPostActions', async () => {
        ...
        await testStore.dispatch(
            PostActionsUtils.lastPostActions(newPost, websocketProps),
        );
        expect(testStore.getActions()).toEqual([
            INCREASED_POST_VISIBILITY,
            {
    ...
    test('setChannelReadAndView', async () => {
        ...
        await testStore.dispatch(
            PostActionsUtils.setChannelReadAndView(newPost, websocketProps),
        );
