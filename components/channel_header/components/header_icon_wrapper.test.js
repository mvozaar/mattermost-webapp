...
describe('components/channel_header/components/HeaderIconWrapper', () => {
    ...
    const mentionsIcon = (
        <MentionsIcon className='icon icon__mentions' aria-hidden='true' />
    );
    ...
    test('should match snapshot, on MentionsIcon', () => {
        const wrapper = shallow(<HeaderIconWrapper {...baseProps} />);
    ...
    test('should match snapshot, on FlagIcon', () => {
        const flagIcon = (
            <FlagIcon className='icon icon__flag' aria-hidden='true' />
        );
        ...
        const wrapper = shallow(<HeaderIconWrapper {...props} />);
    ...
    test('should match snapshot, on PinIcon', () => {
        const pinIcon = (
            <PinIcon className='icon icon__pin' aria-hidden='true' />
        );
        ...
        const props = {
            ...
            buttonClass: 'pinned_posts_class',
        };
    ...
    test('should match snapshot, on PluginIcon with tooltipText', () => {
        const pluginIcon = <i className='fa fa-anchor' />;

        const props = {
            ...baseProps,
            iconComponent: pluginIcon,
            tooltipKey: 'plugin',
            tooltipText: 'plugin_tooltip_text',
        };
