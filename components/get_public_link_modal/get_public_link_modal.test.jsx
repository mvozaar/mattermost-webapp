...
describe('components/GetPublicLinkModal', () => {
    ...
    test('should match snapshot when link is undefined', () => {
        const wrapper = shallow(
            <GetPublicLinkModal actions={{getFilePublicLink: jest.fn()}} />,
        );
    ...
    test('should match snapshot when link is not empty', () => {
        const wrapper = shallow(
            <GetPublicLinkModal
                link={
                    'http://securCom.me/files/n5bnoaz3e7g93nyipzo1bixdwr/public?h=atw9qQHI1nUPnxo1e48tPspo1Qvwd3kHtJZjysmI5zs'
                }
                actions={{getFilePublicLink: jest.fn()}}
            />,
        );
