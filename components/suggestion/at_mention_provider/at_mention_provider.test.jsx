...
describe('components/suggestion/at_mention_provider/AtMentionProvider', () => {
    ...
    it('should ignore pretexts that are not at-mentions', () => {
        ...
        expect(provider.handlePretextChanged('', resultCallback)).toEqual(
            false,
        );

        expect(provider.handlePretextChanged('user', resultCallback)).toEqual(
            false,
        );

        expect(
            provider.handlePretextChanged('this is a sentence', resultCallback),
        ).toEqual(false);
    ...
    it("should suggest for '@'", async () => {
        ...
        const params = {
            ...baseParams,
            autocompleteUsersInChannel: jest.fn().mockImplementation(
                () =>
                    new Promise((resolve) => {
                        resolve({
                            data: {
        ...
        const resultCallback = jest.fn();
        expect(provider.handlePretextChanged(pretext, resultCallback)).toEqual(
            true,
        );
    ...
    it("should suggest for '@h'", async () => {
        ...
        expect(resultCallback).toHaveBeenNthCalledWith(1, {
            ...
            items: [{type: Constants.MENTION_SPECIAL, username: 'here'}],
    ...
    it("should suggest for username match '@user'", async () => {
        ...
        expect(resultCallback).toHaveBeenNthCalledWith(1, {
            ...
            items: [{type: Constants.MENTION_MEMBERS, ...userid2}],
        ...
        await Promise.resolve().then(() => {
            expect(resultCallback).toHaveBeenNthCalledWith(3, {
                matchedPretext,
                terms: ['@user2', '@user4', '@user5', '@user.six-split'],
    ...
    it("should suggest for username match '@six'", async () => {
        ...
        expect(resultCallback).toHaveBeenNthCalledWith(2, {
            ...
            items: [{type: Constants.MENTION_MORE_MEMBERS, loading: true}],
        ...
        await Promise.resolve().then(() => {
            expect(resultCallback).toHaveBeenNthCalledWith(3, {
                matchedPretext,
                terms: ['@user.six-split'],

                items: [{type: Constants.MENTION_NONMEMBERS, ...userid6}],
    ...
    it("should suggest for first_name match '@X'", async () => {
        ...
        expect(resultCallback).toHaveBeenNthCalledWith(1, {
            ...
            items: [{type: Constants.MENTION_MEMBERS, ...userid3}],
