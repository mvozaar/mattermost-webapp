            ...
            >
                <MenuGroup>
                    <MenuItemAction
                        ...
                        icon={
                            this.props.mobile && (
                                <i className='mentions'>{'@'}</i>
                            )
                        }
                        text={localizeMessage(
                            'sidebar_right_menu.recentMentions',
                            'Recent Mentions',
                        )}
                    />
                ...
                <MenuGroup>
                    <MenuItemToggleModalRedux
                        ...
                        dialogType={UserSettingsModal}
                        text={localizeMessage(
                            'navbar_dropdown.accountSettings',
                            'Account Settings',
                        )}
                ...
                <MenuGroup>
                    ...
                    >
                        <MenuItemToggleModalRedux
                            ...
                            text={localizeMessage(
                                'navbar_dropdown.addGroupsToTeam',
                                'Add Groups to Team',
                            )}
                            icon={
                                this.props.mobile && (
                ...
                <MenuGroup>
                    ...
                    >
                        ...
                        >
                            <MenuItemAction
                                ...
                                show={
                                    this.props.teamType ===
                                        Constants.OPEN_TEAM &&
                                    this.props.enableUserCreation &&
                                    !teamIsGroupConstrained
                                }
                                onClick={this.showGetTeamInviteLinkModal}
                                text={localizeMessage(
                                    'navbar_dropdown.teamLink',
                        ...
                        <MenuItemToggleModalRedux
                            ...
                            text={localizeMessage(
                                'navbar_dropdown.addMemberToTeam',
                                'Add Members to Team',
                            )}
                            icon={
                                this.props.mobile && (
                ...
                <MenuGroup>
                    ...
                    <MenuItemToggleModalRedux
                        ...
                        text={localizeMessage(
                            'navbar_dropdown.manageMembers',
                            'Manage Members',
                        )}
                        icon={
                            this.props.mobile && <i className='fa fa-users' />
                        }
                    />
                </MenuGroup>
                <MenuGroup>
                    ...
                    <MenuItemLink
                        id='joinTeam'
                        show={
                            !this.props.experimentalPrimaryTeam &&
                            this.props.moreTeamsToJoin
                        }
                        to='/select_team'
                        text={localizeMessage(
                            'navbar_dropdown.join',
                            'Join Another Team',
                        )}
                        icon={
                            this.props.mobile && (
                    ...
                    <MenuItemToggleModalRedux
                        ...
                        text={localizeMessage(
                            'navbar_dropdown.leave',
                            'Leave Team',
                        )}
                        icon={this.props.mobile && <LeaveTeamIcon />}
                    />
                </MenuGroup>
                <MenuGroup>{pluginItems}</MenuGroup>
                <MenuGroup>
                    <TeamPermissionGate
                        teamId={this.props.teamId}
                        permissions={[
                ...
                <MenuGroup>
                    ...
                    <MenuItemAction
                        ...
                        text={localizeMessage(
                            'navbar_dropdown.keyboardShortcuts',
                            'Keyboard Shortcuts',
                        )}
                    />
                    ...
                    <MenuItemExternalLink
                        ...
                        icon={
                            this.props.mobile && <i className='fa fa-phone' />
                        }
                    />
                    ...
                    <MenuItemExternalLink
                        id='nativeAppLink'
                        show={
                            this.props.appDownloadLink &&
                            !UserAgent.isMobileApp()
                        }
                        url={useSafeUrl(this.props.appDownloadLink)}
                        text={localizeMessage(
                            'navbar_dropdown.nativeApps',
                            'Download Apps',
                        )}
                        icon={
                            this.props.mobile && <i className='fa fa-mobile' />
                        }
                    />
