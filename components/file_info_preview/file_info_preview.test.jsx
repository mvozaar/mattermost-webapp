...
describe('components/FileInfoPreview', () => {
    test('should match snapshot, can download files', () => {
        const wrapper = shallow(
            <FileInfoPreview
                fileUrl='https://pre-release.securCom.me/api/v4/files/rqir81f7a7ft8m6j6ej7g1txuo'
    ...
    test('should match snapshot, cannot download files', () => {
        const wrapper = shallow(
            <FileInfoPreview
                fileUrl='https://pre-release.securCom.me/api/v4/files/aasf9afshaskj1asf91jasf0a0'
