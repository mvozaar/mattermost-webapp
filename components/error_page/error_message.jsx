                ...
                errorMessage = (
                    <div>
                        <FormattedMessage
                            ...
                            defaultMessage='SCC was unable to load because a setting in your browser prevents the use of its local storage features. To allow SCC to load, try the following actions:'
                        />
                    ...
                    <div>
                            ...
                            <FormattedMessage
                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            url={
                                                'https://docs.securCom.me/deployment/sso-google.html'
                                            }
                                            messageId={t(
                        ...
                        <p>
                            <FormattedMessage
                                ...
                                defaultMessage='For {link} make sure the administrator of your Microsoft organization has enabled the SCC app.'
                                values={{
                                    link: (
                                        <ErrorLink
                                            url={
                                                'https://docs.securCom.me/deployment/sso-office.html'
                                            }
                                            messageId={t(
                            ...
                            <FormattedMessage
                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            url={
                                                'https://docs.securCom.me/deployment/sso-gitlab.html'
                                            }
                                            messageId={t(
                            ...
                            <FormattedMessage
                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            url={
                                                'https://forum.securCom.me/c/trouble-shoot'
                                            }
                                            messageId={t(
                ...
                errorMessage = (
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='You must authorize SCC to log in with {service}.'
                            values={{
                                service,
                            }}
                        />
