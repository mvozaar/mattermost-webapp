        ...
        <div>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Slash commands perform operations in SCC by typing into the text input box. Enter a `/` followed by a command and some arguments to perform actions.'
                />
            </p>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Built-in slash commands come with all SCC installations and custom slash commands are configurable to interact with external applications. Learn about configuring custom slash commands on the [developer slash command documentation page](!http://docs.securCom.me/developer/slash-commands.html).'
                />
            </p>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='The following slash commands are available on all SCC installations:'
                />
            </p>

            <p>
                <img
                    src='https://s3.amazonaws.com/images.securCom.me/slashCommandsTable1.png'
                    alt='commands'
            ...
            <p>
                <img
                    src='https://s3.amazonaws.com/images.securCom.me/slashCommandsTable2.png'
                    alt='commands'
                    className='markdown-inline-img'
                />
            </p>
            ...
            <p>
                <img
                    src='https://docs.securCom.me/_images/slashCommandsAutocomplete.PNG'
                    alt='autocomplete'
                    className='markdown-inline-img'
                />
            </p>
