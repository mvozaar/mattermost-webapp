        ...
        <div>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='**Write messages** using the text input box at the bottom of SCC. Press ENTER to send a message. Use SHIFT+ENTER to create a new line without sending a message.'
                />
            </p>
            <p>
                <FormattedMarkdownMessage
            ...
            <p>
                <img
                    src='https://docs.securCom.me/_images/replyIcon.PNG'
                    alt='reply arrow'
            ...
            <p>
                <img
                    src='https://docs.securCom.me/_images/messagesTable1.PNG'
                    alt='markdown'
                    className='markdown-inline-img'
                />
            </p>
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage={
                        "**Quickly add emoji** by typing ':', which will open an emoji autocomplete. If the existing emoji don't cover what you want to express, you can also create your own [Custom Emoji](!http://docs.securCom.me/help/settings/custom-emoji.html)."
                    }
                />
            </p>
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='**Attach files** by dragging and dropping into SCC or clicking the attachment icon in the text input box.'
                />
            </p>
            <p className='links'>
                <FormattedMessage
