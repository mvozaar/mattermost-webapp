...
describe('components/MoreChannels', () => {
    ...
    test('should match snapshot and state', () => {
        const wrapper = shallow(<MoreChannels {...baseProps} />);
    ...
    test('should call props.onModalDismissed on handleExit', () => {
        ...
        const wrapper = shallow(<MoreChannels {...props} />);
    ...
    test('should call props.getChannels on nextPage', () => {
        ...
        expect(instance.props.actions.getChannels).toHaveBeenCalledWith(
            instance.props.teamId,
            2,
            50,
        );
    });
    ...
    test('should attempt to join the channel and fail', (done) => {
        ...
        expect(instance.props.actions.joinChannel).toHaveBeenCalledWith(
            instance.props.currentUserId,
            instance.props.teamId,
    ...
    test('should handle a failed search', (done) => {
        ...
        jest.runAllTimers();
        expect(instance.props.actions.searchMoreChannels).toHaveBeenCalledTimes(
            1,
        );

        expect(instance.props.actions.searchMoreChannels).toHaveBeenCalledWith(
            'fail',
        );
