...
function makeMapStateToProps() {
    ...
    return (state, ownProps) => {
        ...
        const currentChannelMembersCount = getCurrentChannelStats(state)
            ? getCurrentChannelStats(state).member_count
            : 1;
        ...
        const userIsOutOfOffice =
            getStatusForUserId(state, currentUserId) ===
        ...
        return {
            ...
            codeBlockOnCtrlEnter: getBool(
                state,
                PreferencesRedux.CATEGORY_ADVANCED_SETTINGS,
            ...
            showTutorialTip:
                enableTutorial && tutorialStep === TutorialSteps.POST_POPOVER,
