...
describe('components/post_view/PostInfo', () => {
    ...
    test('should match snapshot, pinned post', () => {
        ...
        const requiredPropsWithPinnedPost = {
            ...requiredProps,
            post: pinnedPost,
        };
    ...
    test('should match snapshot, ephemeral post', () => {
        ...
        const requiredPropsWithEphemeralPost = {
            ...requiredProps,
            post: ephemeralPost,
        };

        const wrapper = shallow(
            <PostInfo {...requiredPropsWithEphemeralPost} />,
        );
    ...
    test('should match snapshot, ephemeral deleted post', () => {
        const deletedEphemeralPost = {
            ...post,
            type: Constants.PostTypes.EPHEMERAL,
            state: Posts.POST_DELETED,
        };

        const requiredPropsWithDeletedEphemeralPost = {
            ...requiredProps,
            post: deletedEphemeralPost,
        };

        const wrapper = shallow(
            <PostInfo {...requiredPropsWithDeletedEphemeralPost} />,
        );
    ...
    test('should match snapshot, enable emoji picker', () => {
        const wrapper = shallow(
            <PostInfo {...requiredProps} enableEmojiPicker={true} />,
        );
    ...
    test('toggleEmojiPicker, should have called props.handleDropdownOpened', () => {
        ...
        const requiredPropsWithHandleDropdownOpened = {
            ...requiredProps,
        ...
        const wrapper = shallow(
            <PostInfo {...requiredPropsWithHandleDropdownOpened} />,
        );
    ...
    test('removePost, should have called props.actions.removePost(post)', () => {
        ...
        const requiredPropsWithRemovePost = {
            ...requiredProps,
            actions,
            enableEmojiPicker: true,
        };
