...
describe('components/post_view/MessageAttachment', () => {
    ...
    test('should call actions.doPostActionWithCookie on handleAction', () => {
        ...
        const props = {
            ...baseProps,
            actions: {doPostActionWithCookie},
        ...
        expect(doPostActionWithCookie).toBeCalledWith(
            props.postId,
            'attr_some_value',
            'attr_some_value',
        );
    ...
    test('should proxy external images if image proxy is enabled', () => {
        ...
        expect(wrapper.find('.attachment__author-icon').prop('src')).toMatch(
            `/api/v4/image?url=${encodeURIComponent(
                props.attachment.author_icon,
            )}`,
        );
    ...
    test('should match snapshot when the attachment has a link in the title', () => {
        const props = {
            ...baseProps,
            attachment: {
                title: 'Do you like https://securCom.me?',
            },
        };
