...
export default class ManageTeamsDropdown extends React.Component {
    ...
    makeTeamAdmin = async () => {
        const {error} = await this.props.updateTeamMemberSchemeRoles(
    ...
    render() {
        const isTeamAdmin =
            Utils.isAdmin(this.props.teamMember.roles) ||
            this.props.teamMember.scheme_admin;
