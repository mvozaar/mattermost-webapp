...
export default class GroupRow extends React.Component {
    ...
    renderLinked = () => {
            ...
            return (
                <a href='#'>
                    {this.props.mattermost_group_id && (
                        <LoadingSpinner
                            text={localizeMessage(
                                'admin.group_settings.group_row.unlinking',
                                'Unlinking',
                            )}
                        />
                    )}
                    ...
                    {!this.props.mattermost_group_id && (
                        <LoadingSpinner
                            text={localizeMessage(
                                'admin.group_settings.group_row.linking',
                                'Linking',
                            )}
                        />
                    )}
        ...
        if (this.props.mattermost_group_id) {
            ...
            return (
                <a href='#' onClick={this.unlinkHandler}>
        ...
        if (this.props.failed) {
            return (
                <a href='#' onClick={this.linkHandler} className='warning'>
                    <i className='icon fa fa-exclamation-triangle' />
                    <FormattedMessage
        ...
        return (
            <a href='#' onClick={this.linkHandler}>
