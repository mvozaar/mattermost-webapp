...
describe('components/LocalDateTime', () => {
    ...
    test('should render date without timezone', () => {
        const wrapper = mountWithIntl(
            <LocalDateTime
                eventTime={new Date(
                    'Fri Jan 12 2018 20:15:13 GMT+0800 (+08)',
                ).getTime()}
            />,
        );

        expect(wrapper.find('time').prop('title')).toBe(
            'Fri Jan 12 2018 12:15:13 GMT+0000',
        );
    ...
    test('should render date without timezone enabled, in military time', () => {
        const wrapper = mountWithIntl(
            <LocalDateTime
                eventTime={new Date(
                    'Fri Jan 12 2018 23:15:13 GMT+0800 (+08)',
                ).getTime()}
        ...
        expect(wrapper.find('time').prop('title')).toBe(
            'Fri Jan 12 2018 15:15:13 GMT+0000',
        );
    ...
    test('should render date with timezone enabled, but no timezone defined', () => {
        ...
        const wrapper = mountWithIntl(
            <LocalDateTime
                eventTime={new Date(
                    'Fri Jan 12 2018 20:15:13 GMT+0000 (+00)',
                ).getTime()}
                enableTimezone={true}
            />,
        );
        ...
        expect(wrapper.find('time').prop('title')).toEqual(
    ...
    test('should render date with timezone enabled', () => {
        ...
        expect(wrapper.find('time').prop('title')).toBe(
            'Sat Jan 13 2018 07:15:13 GMT+1100 (Australia/Sydney)',
        );
    ...
    test('should render date with timezone enabled, in military time', () => {
        const wrapper = mountWithIntl(
            <LocalDateTime
                eventTime={new Date(
                    'Fri Jan 12 2018 20:15:13 GMT-0800 (+00)',
                ).getTime()}
                useMilitaryTime={true}
                enableTimezone={true}
                timeZone={'Australia/Sydney'}
        ...
        expect(wrapper.find('time').prop('title')).toBe(
            'Sat Jan 13 2018 15:15:13 GMT+1100 (Australia/Sydney)',
        );
